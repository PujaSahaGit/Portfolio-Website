...
photos=[]
for i in range (0 ,3):
    with open(f"{i+1}t.txt", errors="ignore") as f:
        text=f.read()
...
Label(f0 ,text="Puja News", font="lucida 33 bold").pack()
Label(f0 ,text="apr 28 1999" , font="lucida 13 bold").pack()
f0.pack()
...
Label(f3 ,omage=photos[2],anchor="e").pack()
f3.pack(anchor="w")
